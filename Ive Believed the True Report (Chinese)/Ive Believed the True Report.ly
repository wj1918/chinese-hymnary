...
\header {
  subtitle = \markup {\fontsize #5 "我已得佳美信息"}
  composer = \markup { \center-column { "Charles Price Jones, 1908" \vspace #1 } }
}
...
}
{
  <<
    \new ChoirStaff <<
      ...
      \new Staff = "Staff 1"
      <<
        \new Voice = "Staff1"  {  << \include "Staff1.ly" >> }
        \new Lyrics \lyricsto "Staff1" { \override LyricText #'X-offset = #align  << \include "Staff1Alyrics.ly" >> }
        \new Lyrics \lyricsto "Staff1" { \override LyricText #'X-offset = #align  << \include "Staff1Blyrics.ly" >> }
        \new Lyrics \lyricsto "Staff1" { \override LyricText #'X-offset = #align  << \include "Staff1Clyrics.ly" >> }
        \new Lyrics \lyricsto "Staff1" { \override LyricText #'X-offset = #align  << \include "Staff1Dlyrics.ly" >> }
      >>
      \new Staff = "I\'ve Believed the Report"
      <<
        \new Voice = "I'veBelievedtheReport"  {  << \include "I'veBelievedtheReport.ly" >> }
      >>
    >>
  >>
}
