...
\header {
  subtitle = \markup {\fontsize #5 "Though Your Sins Be as Scarlet"}
  composer = \markup { \center-column { "Music: William Howard Doane" \vspace #1 } }
  poet = \markup { \center-column { "Lyrics: Frances Jane (Fanny) Crosby, 1887" \vspace #1  } }
}
